%%% PENDIENTES
%%%- Cambiar el fondo de los bloques para mejor vista y meter los nombres de colores y archivos correspondientes en el archivo de estilos adecuado.
%%%-Crear la opción de incluir autores con valor vacío por default en los bloques.
